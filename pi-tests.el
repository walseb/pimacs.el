...
(ert-deftest pi--parse-slash-command ()
  ...
  (should (null (pi--parse-slash-command "")))
  (should (null (pi--parse-slash-command "line1\n/model")))
  (should (null (pi--parse-slash-command "line1\n  /model")))
  (should (null (pi--parse-slash-command "line1\n/unknown")))
  (should (equal (pi--parse-slash-command "\n/model") '(pi-select-model . nil)))
  (should (equal (pi--parse-slash-command "\n\n/model") '(pi-select-model . nil)))
...
(ert-deftest pi--parse-bang-command ()
  ...
  (should (null (pi--parse-bang-command "")))
  (should (null (pi--parse-bang-command "line1\n!ls")))
  (should (null (pi--parse-bang-command "line1\n  !ls")))
  (should (null (pi--parse-bang-command "line1\n!ls -la")))
  (should (equal (pi--parse-bang-command "\n!ls") "ls"))
  (should (equal (pi--parse-bang-command "\n\n!ls") "ls")))
...
(ert-deftest pi--parse-double-bang-command ()
  ...
  (should (null (pi--parse-double-bang-command "")))
  (should (null (pi--parse-double-bang-command "line1\n!!ls")))
  (should (null (pi--parse-double-bang-command "line1\n  !!ls")))
  (should (null (pi--parse-double-bang-command "line1\n!!ls -la")))
  (should (equal (pi--parse-double-bang-command "\n!!ls") "ls"))
  (should (equal (pi--parse-double-bang-command "\n\n!!ls") "ls")))
